...
module nios_mm_interconnect_0 (
		...
		input  wire        rs232_reset_reset_bridge_in_reset_reset, // rs232_reset_reset_bridge_in_reset.reset
	...
	wire  [13:0] rs232_s1_agent_m0_address;                                                  // rs232_s1_agent:m0_address -> rs232_s1_translator:uav_address
	...
	wire  [88:0] rs232_s1_agent_rf_source_data;                                              // rs232_s1_agent:rf_source_data -> rs232_s1_agent_rsp_fifo:in_data
	...
	wire  [88:0] rs232_s1_agent_rsp_fifo_out_data;                                           // rs232_s1_agent_rsp_fifo:out_data -> rs232_s1_agent:rf_sink_data
	...
	wire         cmd_mux_001_src_valid;                                                      // cmd_mux_001:src_valid -> rs232_s1_agent:cp_valid
	wire  [87:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> rs232_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                      // rs232_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> rs232_s1_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                              // cmd_mux_001:src_startofpacket -> rs232_s1_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                // cmd_mux_001:src_endofpacket -> rs232_s1_agent:cp_endofpacket
	...
	wire  [87:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> memoria_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                      // memoria_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> memoria_s1_agent:cp_channel
	...
	wire         rs232_s1_agent_rp_valid;                                                    // rs232_s1_agent:rp_valid -> router_003:sink_valid
	wire  [87:0] rs232_s1_agent_rp_data;                                                     // rs232_s1_agent:rp_data -> router_003:sink_data
	wire         rs232_s1_agent_rp_ready;                                                    // router_003:sink_ready -> rs232_s1_agent:rp_ready
	wire         rs232_s1_agent_rp_startofpacket;                                            // rs232_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         rs232_s1_agent_rp_endofpacket;                                              // rs232_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [87:0] memoria_s1_agent_rp_data;                                                   // memoria_s1_agent:rp_data -> router_005:sink_data
	...
	wire         rs232_s1_agent_rdata_fifo_src_valid;                                        // rs232_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] rs232_s1_agent_rdata_fifo_src_data;                                         // rs232_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         rs232_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_001:in_0_ready -> rs232_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                          // avalon_st_adapter_001:out_0_valid -> rs232_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                           // avalon_st_adapter_001:out_0_data -> rs232_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                          // rs232_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                          // avalon_st_adapter_001:out_0_error -> rs232_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_clk_clk),                             //                      clk.clk
		.reset                  (rs232_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_clk_clk),                               //             clk.clk
		.reset                   (rs232_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	nios_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_clk_clk),                             // in_clk_0.clk
		.in_rst_0_reset (rs232_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
